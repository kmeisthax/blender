...
/** \file
 * \ingroup GHOST
 * Declaration of GHOST_SystemUIKit class.
 */

#pragma once

#ifndef __APPLE__
#  error Apple iPadOS only!
#endif  // __APPLE__
...
class GHOST_WindowUIKit;

class GHOST_SystemUIKit : public GHOST_System {
 public:
  /**
   * Constructor.
   */
  ...
  /**
   * Handles a window event. Called by GHOST_WindowUIKit window delegate
   * \param eventType: The type of window event.
   * \param window: The window on which the event occurred.
   * \return Indication whether the event was handled.
   */
  GHOST_TSuccess handleWindowEvent(GHOST_TEventType eventType, GHOST_WindowUIKit *window);
 ...
 protected:
  ...
  /**
   * Signal from our UIWindowSceneDelegate that a new window has been created
   */
  void systemDidCreateMainWindow(GHOST_WindowUIKit* main_window);
   ...
   * The main window.
   * 
   * Because GHOST's window creation can't actually run synchronously, I'm just
   * caching the first window that gets created for now.
   */
  GHOST_WindowUIKit* m_mainWindow;
};
