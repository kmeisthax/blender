...
/** \file
 * \ingroup GHOST
 * Declaration of GHOST_WindowUIKit class.
 */
...
class GHOST_WindowUIKit : public GHOST_Window {
 public:
  /**
   * Constructor.
   * Latches onto an existing UIKit window
   * To check if the window was created properly, use the #getValid() method.
   * \param systemUIKit: The associated system class to forward events to.
