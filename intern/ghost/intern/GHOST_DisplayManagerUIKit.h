...
/** \file
 * \ingroup GHOST
 * Declaration of GHOST_DisplayManagerUIKit class.
 */
...
/**
 * Manages system displays  (iPadOS/UIKit/Cocoa Touch implementation).
 * \see GHOST_DisplayManager
 */
class GHOST_DisplayManagerUIKit : public GHOST_DisplayManager {
 public:
  /**
   * Constructor.
   */
  GHOST_DisplayManagerUIKit(void);
